...
from app.routers import auth, config, init, leaderboard, live, matches, predictions, results, users
...
for router in [auth, config, init, leaderboard, live, matches, predictions, results, users]:
